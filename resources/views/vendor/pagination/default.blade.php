    ...
    <nav>
        <ul class="pagination">
            ...
            @if ($paginator->onFirstPage())
                <li class="page-numbers disabled" aria-disabled="true" aria-label="@lang('pagination.previous')">
            ...
            @foreach ($elements as $element)
                ...
                @if (is_string($element))
                    <li class="page-numbers disabled" aria-disabled="true"><span>{{ $element }}</span></li>
                @endif
            ...
            @else
                <li class="page-numbers disabled" aria-disabled="true" aria-label="@lang('pagination.next')">
