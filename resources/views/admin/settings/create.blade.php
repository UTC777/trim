    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.settings.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('short_bio') ? 'is-invalid' : '' }}" name="short_bio" id="short_bio">{{ old('short_bio') }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('google_map_link') ? 'is-invalid' : '' }}" type="text" name="google_map_link" id="google_map_link" value="{{ old('google_map_link', '') }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('long_bio') ? 'is-invalid' : '' }}" name="long_bio" id="long_bio">{!! old('long_bio') !!}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('additional_social_link') ? 'is-invalid' : '' }}" type="text" name="additional_social_link" id="additional_social_link" value="{{ old('additional_social_link', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('additional_social_link_icon') ? 'is-invalid' : '' }}" type="text" name="additional_social_link_icon" id="additional_social_link_icon" value="{{ old('additional_social_link_icon', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('additional_social_link_2') ? 'is-invalid' : '' }}" type="text" name="additional_social_link_2" id="additional_social_link_2" value="{{ old('additional_social_link_2', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('additional_social_link_icon_2') ? 'is-invalid' : '' }}" type="text" name="additional_social_link_icon_2" id="additional_social_link_icon_2" value="{{ old('additional_social_link_icon_2', '') }}">
