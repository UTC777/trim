...
<div class="card">
    ...
    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-SuccessStory">
            <thead>
                <tr>
                    <th width="10">
                    ...
                    <th>
                        {{ trans('cruds.successStory.fields.published') }}
                    </th>
                    <th>
                        &nbsp;
                    </th>
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.success-stories.index') }}",
    columns: [
      { data: 'placeholder', name: 'placeholder' },
{ data: 'id', name: 'id' },
{ data: 'title', name: 'title' },
{ data: 'story_about', name: 'story_about' },
{ data: 'services_used', name: 'services_useds.title' },
...
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-SuccessStory').DataTable(dtOverrideGlobals);
