...
{{--@include('admin.staticSeos.partials.global.top')--}}
{{--@include('admin.staticSeos.partials.global.seo-image')--}}
{{--@include('admin.staticSeos.partials.global.seo-meta')--}}

{{--<div class="row">--}}
{{--    @include('admin.staticSeos.partials.global.microdata')--}}
{{--    @include('admin.staticSeos.partials.global.jsonld')--}}

{{--</div>--}}
{{--@include('admin.staticSeos.partials.global.seo-class')--}}
