        ...
        <form method="POST" action="{{ route("admin.faq-questions.update", [$faqQuestion->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('use_html_answer') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="use_html_answer" id="use_html_answer" value="1" {{ $faqQuestion->use_html_answer || old('use_html_answer', 0) === 1 ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('html_answer') ? 'is-invalid' : '' }}" name="html_answer" id="html_answer">{{ old('html_answer', $faqQuestion->html_answer) }}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('youtube_video_id_only') ? 'is-invalid' : '' }}" type="text" name="youtube_video_id_only" id="youtube_video_id_only" value="{{ old('youtube_video_id_only', $faqQuestion->youtube_video_id_only) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('video_button_text') ? 'is-invalid' : '' }}" type="text" name="video_button_text" id="video_button_text" value="{{ old('video_button_text', $faqQuestion->video_button_text) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('read_more_link') ? 'is-invalid' : '' }}" type="text" name="read_more_link" id="read_more_link" value="{{ old('read_more_link', $faqQuestion->read_more_link) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('read_more_button_text') ? 'is-invalid' : '' }}" type="text" name="read_more_button_text" id="read_more_button_text" value="{{ old('read_more_button_text', $faqQuestion->read_more_button_text) }}">
