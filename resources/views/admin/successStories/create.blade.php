        ...
        <form method="POST" action="{{ route("admin.success-stories.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('use_before_after') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="use_before_after" id="use_before_after" value="1" {{ old('use_before_after', 0) == 1 || old('use_before_after') === null ? '' : '' }}>
            ...
            <div class="form-group">
                <div class="form-check {{ $errors->has('use_combined') ? 'is-invalid' : '' }}">
                    ...
                    <input class="form-check-input" type="checkbox" name="use_combined" id="use_combined" value="1" {{ old('use_combined', 0) == 1 || old('use_combined') === null ? '' : '' }}>
            ...
            <div class="form-group">
                ...
                @endif
                <span class="help-block">{{ trans('cruds.successStory.fields.slug_helper') }}</span>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('story_category') ? 'is-invalid' : '' }}" name="story_category_id" id="story_category_id">
                    @foreach($story_categories as $id => $entry)
                        <option value="{{ $id }}" {{ old('story_category_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
